...
This privacy policy applies to the 3秒メモ app for mobile devices, together with any related services operated by Tea (collectively, the "Application"). Tea is hereby referred to as the "Service Provider".
...
You may request access to, correction of, or deletion of your personal data held by the Service Provider. To exercise these rights, or to withdraw consent where processing is based on consent, contact the Service Provider at tea.19.job@gmail.com.

**Your California privacy rights (CCPA/CPRA)**

If you are a California resident, you have the right to know what personal information is collected, the right to delete personal information, the right to opt out of the sale or sharing of personal information, and the right to non-discrimination for exercising these rights. To exercise your CCPA/CPRA rights, contact the Service Provider at tea.19.job@gmail.com.
...
Where the Application provides subscriptions or in-app purchases, the Service Provider may process information necessary to manage purchases, such as purchase status, subscription expiration date, purchase history, receipt information, and anonymous or pseudonymous identifiers used to identify you, through Apple, RevenueCat, and other third-party services. The Service Provider does not obtain or store payment information processed by Apple, such as credit card numbers.
...
To request deletion of your personal data, to withdraw consent, or to exercise any of your rights, contact the Service Provider at tea.19.job@gmail.com.
...
You may request deletion of your personal data, subject to any legal obligation to retain it. If you want the Service Provider to delete User Provided Data submitted through the Application, please contact them at tea.19.job@gmail.com. Please note that some User Provided Data may be required for the Application to function properly.
...
Previous versions of this Privacy Policy will be maintained and made available upon request by contacting the Service Provider at tea.19.job@gmail.com.
...
If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at tea.19.job@gmail.com.
