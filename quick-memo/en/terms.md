...
These terms and conditions apply to the 3秒メモ app for mobile devices, together with any related services operated by Tea (collectively, the "Application"). Tea is hereby referred to as the "Service Provider".
...
The Service Provider may review reported content, request additional information where necessary, remove or restrict access to content, and take action against the responsible account where appropriate. Users affected by moderation decisions may contact the Service Provider at tea.19.job@gmail.com to request further review. The Service Provider will respond to appeals within a reasonable period and provide the reasons for any upheld moderation decision, subject to applicable law.
...
Payment processing, billing, refunds, and purchase disputes are handled according to Apple's terms and procedures. The Service Provider does not obtain or store payment information processed by Apple, such as credit card numbers. If you wish to request a refund, please follow the refund request process provided by Apple.

The Service Provider may change the content, price, and terms of paid features to the extent permitted by law. If there is a material change, the Service Provider will notify you in the Application or by another appropriate method. If you continue using the paid features after the change, you will be deemed to have agreed to the changed terms.
...
**Point of Contact:** The Service Provider maintains a single point of contact for direct communication with EU authorities and recipients of the service, reachable at tea.19.job@gmail.com. Where the Service Provider is established outside the European Union, a legal representative in the EU has been designated in accordance with Article 13 of the DSA.
...
Previous versions of these Terms and Conditions will be maintained and made available upon request by contacting the Service Provider at tea.19.job@gmail.com.

These terms and conditions are effective as of 2026-05-27

**Contact Us**

If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at tea.19.job@gmail.com.
